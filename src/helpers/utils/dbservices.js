...
export const createDocument = (model, data) => {
...
export const updateDocument = (model, id, data) => {
...
export const deleteMultipleDocuments = (model, ids) => {
...
export const getAllDocuments = async (model, query, options) => {
...
export const getSingleDocumentById = (model, id, select = []) => {
...
export const findExistsData = (model, data) => {
    // let { model } = data;
    const { query } = data;
    const { and } = query;
    const { or } = query;
...
export const getDocumentByAggregation = (model, query) => {
    let keyInJson;
...
export const softDeleteMultiDocuments = async (model, ids, data) => {
...
export const softDeleteDocument = (model, id) => {
...
export const bulkInsert = (model, data) => {
...
export const bulkUpdate = (model, filter, data) => {
...
export const countDocument = (model, where) => {
...
export const getDocumentByQuery = (model, where, select = []) => {
...
export const getDocumentByQueryWithPopulate = (model, where, populate, select = []) => {
...
export const findOneAndUpdateDocument = (model, filter, data, options = { new: true }, populate = []) => {
...
export const findOneAndDeleteDocument = (model, filter, options = {}) => {
...
export const deleteDocument = (model, filter) => {
